...
Task.insertCart = (req) => req.useConnection((connection) => CartService.insertCart(connection, req.body, req.files))
Task.updateCartBy = (req) => req.useConnection((connection) => CartService.updateCartBy(connection, req.body, req.files))
