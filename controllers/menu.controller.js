...
Task.insertMenu = (req) => req.useConnection((connection) => MenuService.insertMenu(connection, req.body))
Task.updateMenuBy = (req) => req.useConnection((connection) => MenuService.updateMenuBy(connection, req.body))
Task.deleteMenuBy = (req) => req.useConnection((connection) => MenuService.deleteMenuBy(connection, req.body))
