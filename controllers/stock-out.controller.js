...
Task.insertStockOut = (req) => req.useConnection((connection) => StockOutService.insertStockOut(connection, req.body))
Task.updateStockOutBy = (req) => req.useConnection((connection) => StockOutService.updateStockOutBy(connection, req.body))
Task.deleteStockOutBy = (req) => req.useConnection((connection) => StockOutService.deleteStockOutBy(connection, req.body))
