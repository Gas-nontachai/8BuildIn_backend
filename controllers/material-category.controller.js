...
Task.insertMaterialCategory = (req) => req.useConnection((connection) => MaterialCategoryService.insertMaterialCategory(connection, req.body))
Task.updateMaterialCategoryBy = (req) => req.useConnection((connection) => MaterialCategoryService.updateMaterialCategoryBy(connection, req.body))
Task.deleteMaterialCategoryBy = (req) => req.useConnection((connection) => MaterialCategoryService.deleteMaterialCategoryBy(connection, req.body))
