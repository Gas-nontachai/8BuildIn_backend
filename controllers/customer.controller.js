...
Task.insertCustomer = (req) => req.useConnection((connection) => CustomerService.insertCustomer(connection, req.body))
Task.updateCustomerBy = (req) => req.useConnection((connection) => CustomerService.updateCustomerBy(connection, req.body))
Task.deleteCustomerBy = (req) => req.useConnection((connection) => CustomerService.deleteCustomerBy(connection, req.body))
