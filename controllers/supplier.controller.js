...
Task.insertSupplier = (req) => req.useConnection((connection) => SupplierService.insertSupplier(connection, req.body, req.files))
Task.updateSupplierBy = (req) => req.useConnection((connection) => SupplierService.updateSupplierBy(connection, req.body, req.files))
